...
crosshair.Size = UDim2.new(0, 60, 0, 60)  -- Aumentando o tamanho para que as linhas fiquem mais visíveis
crosshair.Position = UDim2.new(0.5, -30, 0.5, -30)  -- Posicionando no centro da tela
...
diagonalLine1.Size = UDim2.new(0, 60, 0, 2)  -- Linha diagonal maior
diagonalLine1.Position = UDim2.new(0.5, -30, 0.5, -1)  -- Posiciona no centro
...
diagonalLine2.Size = UDim2.new(0, 60, 0, 2)  -- Linha diagonal maior
diagonalLine2.Position = UDim2.new(0.5, -30, 0.5, -1)  -- Posiciona no centro
